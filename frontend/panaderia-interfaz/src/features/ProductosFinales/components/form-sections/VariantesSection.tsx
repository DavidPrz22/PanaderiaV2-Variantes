...
import type { TProductoFinalSchema, TProductosFinalesVariantesSchema } from "../../schemas/schemas";
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Define las variantes o presentaciones del producto final
                    </p>
                </div>
                <Button
                    type="button"
