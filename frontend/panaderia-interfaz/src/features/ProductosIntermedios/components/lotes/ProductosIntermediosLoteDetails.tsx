...
import type { LoteProductoIntermedio } from "@/features/ProductosIntermedios/types/types";
...
interface LoteProductoIntermedioDetailsPanelProps {
  lote: LoteProductoIntermedio;
  onBack: () => void;
  onClose?: () => void;
  onToggleStatus?: (loteId: number) => void;
}

export const LoteProductoIntermedioDetailsPanel = ({
  lote,
  onBack,
  onClose,
  onToggleStatus,
}: LoteProductoIntermedioDetailsPanelProps) => {
